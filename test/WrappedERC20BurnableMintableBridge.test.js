...
describe("WrappedERC20BurnableMintableBridge", () => {
    ...
    beforeEach(async () => {
        ...
        wrappedTokenBridgeFactory = await ethers.getContractFactory("WrappedERC20BurnableMintableBridgeHarnessUpgradable")
